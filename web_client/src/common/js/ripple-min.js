...
if (!window.Tween.Linear) {
	window.Tween.Linear = function(t, e, r, a) {
		return r * t / a + e
	}
}
...
// if (window.location != window.parent.location && /zhangxinxu|localhost/.test(window.parent.location) == false) {
